    ...
    <header className="bg-black shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-6">
          <a
            href="#about"
            className="text-gray-200 font-medium hover:text-blue-500 transition"
          >
            About
          </a>
          ...
          {/* Desktop Nav - GitHub Profile button */}
          <a
            href="https://github.com/BilalQamar110"
            target="_blank"
      ...
      {isOpen && (
        <div className="md:hidden bg-black px-6 pb-4 space-y-3">
          <a
            href="#about"
            className="block text-gray-200 font-medium hover:text-blue-500"
          >
            About
          </a>
          <a
          ...
          {/* Mobile Nav - GitHub Profile button */}
          <a
            href="https://github.com/BilalQamar110"
            target="_blank"
            rel="noopener noreferrer"
